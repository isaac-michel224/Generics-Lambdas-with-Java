...
// below is a simple use of an anonymous class
        ...
        Readable functionReadable = () -> System.out.println("I am reading a comic book");
        functionReadable.doRead();
...
//        students.stream()
//                .filter(student -> student.substring(0,1).equals("J")
//                        .forEach(s -> System.out.println(student));

        students.stream()
                        .filter(student -> charAt(0) == 'J')
                                .forEach(student -> System.out.println(student));

//
        //less idiomatic way of filtering way of filtering a collection
                        ...
                        Function<Integer, Long> myFunction = (x) -> System.out.println(Long.valueOf(x));
                        integers.stream()
                                .map(myFunction)
...
//                       below is the culimation of the functional style fo programming
        // in java, here instead of relying on lambdas, we simply invoke
        //methods with a method reference, thus allowing us to write less code that's ultimately less error-prone
